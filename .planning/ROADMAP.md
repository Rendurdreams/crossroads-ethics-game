...
**Plans:** 3 plans
Plans:
- [ ] 11-01-PLAN.md — Detection logic (VALUE_FRAMEWORK_MAP + findMoralConflicts) + tests + ConsequenceReveal conflict indicator
- [ ] 11-02-PLAN.md — FrameworkProfile moral vs ethics section + pack prop fix
- [ ] 11-03-PLAN.md — AI stubs (ai.js) + endSession debrief_context/group_debrief_context + SQL migration
...
| 11. Moral Conflict Detection + End Screen + AI Hooks | v1.1 | 0/3 | Planning complete | - |
