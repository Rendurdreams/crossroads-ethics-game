...
Plans:
- [ ] 15.1-01-PLAN.md — Fix detection.js: dead fairness tag (VALUE_CONDITION_TRIGGERS) + replace 2 matchFramework triggers with 4 matchCondition entries + update tests
